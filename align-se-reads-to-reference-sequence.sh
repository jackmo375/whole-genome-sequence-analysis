...
input1="/mnt/lustre/users/jmorrice/projects/single-sample-gatk/input-data/SRR011037.filt.fastq.gz"
idSample="NA18486"
idRun="SRR011037"
CN=""
...
/mnt/lustre/users/jmorrice/projects/single-sample-gatk/software/bwa-0.7.17/bwa mem \
    ...
    samtools sort \
        --threads 16 \
        -m 2G - > /mnt/lustre/users/jmorrice/projects/single-sample-gatk/working-data/${idSample}_${idRun}_se.bam
